...
export default function Home() {
  ...
  const activeGallery = useMemo(() => sorted(data.gallery.filter((x) => x.active && (!galleryCategoryId || x.galleryCategoryId === galleryCategoryId))), [data.gallery, galleryCategoryId]);
